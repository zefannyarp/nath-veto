window.pluginsAttached ? alert("Attention: plugins.js library is attached twice and needs to be removed. The slides.min.js already contains both of scripts.") : (window.pluginsAttached = 1),
            ...
            function D(a) {
                ...
                if (Ta !== w && Ta !== x && !ia()) {
                    ...
                    if (
                        ...
                        (Ta = v),
                        2 == Ua &&
                            (0 == Ma ? (la(1, b.touches[1]), (Ma = Na = ua(Va[0].start, Va[1].start))) : (ma(b.touches[1]), (Na = ua(Va[0].end, Va[1].end)), (Qa = wa(Va[0].end, Va[1].end))), (Oa = va(Ma, Na)), (Pa = Math.abs(Ma - Na))),
                    ...
                    k == n
                        ? (j !== x && j !== w) ||
                          ...
                          Z() && !aa()
                              ...
                              : (($a = null), Sa.trigger("tap", [b.target]), c.tap && (q = c.tap.call(Sa, b, b.target))))
                        : k == o
                        ? (j !== x && j !== w) || (clearTimeout(_a), ($a = null), Sa.trigger("doubletap", [b.target]), c.doubleTap && (q = c.doubleTap.call(Sa, b, b.target)))
                        : k == p && ((j !== x && j !== w) || (clearTimeout(_a), ($a = null), Sa.trigger("longtap", [b.target]), c.longTap && (q = c.longTap.call(Sa, b, b.target)))),
                    q
                );
            }
            function L() {
    ...
    (function (a, b, c, d) {
        ...
        var g = "sharrre",
            ...
            j = {
                googlePlus: function (d) {
                    ...
                    a(d.element)
                        .find(".buttons")
                        .append('<div class="button googleplus"><div class="g-plusone" data-size="' + e.size + '" data-href="' + ("" !== e.url ? e.url : d.options.url) + '" data-annotation="' + e.annotation + '"></div></div>'),
                ...
                digg: function (b) {
                    ...
                    a(b.element)
                        .find(".buttons")
                        .append('<div class="button digg"><a class="DiggThisButton ' + d.type + '" rel="nofollow external" href="http://digg.com/submit?url=' + encodeURIComponent("" !== d.url ? d.url : b.options.url) + '"></a></div>');
                    var e = 0;
                ...
                stumbleupon: function (d) {
                    ...
                    a(d.element)
                        .find(".buttons")
                        .append('<div class="button stumbleupon"><su:badge layout="' + e.layout + '" location="' + ("" !== e.url ? e.url : d.options.url) + '"></su:badge></div>');
                    var f = 0;
                ...
                linkedin: function (d) {
                    ...
                    a(d.element)
                        .find(".buttons")
                        .append('<div class="button linkedin"><script type="in/share" data-url="' + ("" !== e.url ? e.url : d.options.url) + '" data-counter="' + e.counter + '"></script></div>');
                    var f = 0;
            ...
            l = {
                googlePlus: function (a) {
                    b.open(
                        "https://plus.google.com/share?hl=" + a.buttons.googlePlus.lang + "&url=" + encodeURIComponent("" !== a.buttons.googlePlus.url ? a.buttons.googlePlus.url : a.url),
                        "",
                ...
                delicious: function (a) {
                    b.open(
                        "http://www.delicious.com/save?v=5&noui&jump=close&url=" + encodeURIComponent("" !== a.buttons.delicious.url ? a.buttons.delicious.url : a.url) + "&title=" + a.text,
                        "delicious",
        ...
        (f.prototype.init = function () {
            var b = this;
            "" !== this.options.urlCurl && ((i.googlePlus = this.options.urlCurl + "?url={url}&type=googlePlus"), (i.stumbleupon = this.options.urlCurl + "?url={url}&type=stumbleupon")),
        ...
        (b.prototype.listen = function () {
            ...
            (c.prototype.close = function () {
                return (
                    ...
                    !1 in document.body.style ? this.dispose() : ((i = this.dispose.bind(this)), this._targetImage.addEventListener("transitionend", i), void this._targetImage.addEventListener("webkitTransitionEnd", i))
                );
            }),
        ...
        if (!c.TweenLite) {
            ...
            (f._init = function () {
                ...
                (f.render = function (a, b, c) {
                    ...
                    if (this._time !== h || c) {
                        ...
                        this._onUpdate && (0 > a && this._startAt && a !== -1e-4 && this._startAt.render(a, b, c), b || ((this._time !== h || d) && this._callback("onUpdate"))),
                            e &&
                                (!this._gc || c) &&
            ...
            if (
                ...
                (f._addTween = function (a, b, c, d, e, f) {
                    var g, h;
                    return null != d && (g = "number" == typeof d || "=" !== d.charAt(1) ? Number(d) - Number(c) : parseInt(d.charAt(0) + "1", 10) * Number(d.substr(2)))
    ...
    $(document).ready(function () {
            ...
            if (((a = parseInt(a)), !((window.isMobile && window.isSimplifiedMobile) || window.isScroll))) {
                ...
                m(),
                    ...
                    0 != window.setStageClasses &&
                        (1 === window.stage && n.addClass("firstSlide"), window.stages === window.stage && 1 !== window.stages && n.addClass("lastSlide"), n.removeClassByPrefix("stage-").addClass("stage-" + window.stage)),
                        ...
                        0 != window.setStageClasses &&
                            (j && l
                                ? (c.prevAll(".slide").addClass("before").removeClass("after"),
                                  ...
                                  window.firstTimeTrigger || ((window.firstTimeTrigger = 1), $(window).trigger("slideChange", [window.stage, c])))
                    ...
                    (window.preload
                        ? window.loaded &&
                          $("[class*='ae-']").each(function (a, b) {
                              var c = $(b);
                              g(c) &&
                                  c.addClass("do").one("webkitAnimationEnd oanimationend msAnimationEnd animationend", function () {
        ...
        function l(a, b) {
            ...
            "number" == typeof window.dropdownInterval && clearInterval(window.dropdownInterval),
                b
                    ...
                    : m(),
                i.indexOf("bottom") != -1 ? ((e -= h.outerHeight()), h.removeClass("top").addClass("bottom")) : ((e += a.outerHeight()), h.removeClass("bottom").addClass("top")),
                i.indexOf("right") != -1
                    ? ((f = f - h.outerWidth() + a.outerWidth()), h.removeClass("left center").addClass("right"))
                    : i.indexOf("left") != -1
                    ? h.removeClass("right center").addClass("left")
                    : i.indexOf("center") != -1 && ((f = f - h.outerWidth() / 2 + a.outerWidth() / 2), h.removeClass("right left").addClass("center")),
        ...
        if (
            ...
            n.hasClass("fast")
                ...
                : n.hasClass("slow") && ((window.slideSpeed = 1400), (window.cleanupDelay = 2e3), (window.effectSpeed = 1400), (window.scrollSpeed = 0.8), (window.effectOffset = 600)),
            (window.stage = 1),
            ...
            n.hasClass("animated")
                ...
                : n.hasClass("animateOnEvent") && ((window.isAnimated = "animateOnEvent"), window.isMobile && ((window.isAnimated = "auto"), n.removeClass("animateOnEvent").addClass("animated"))),
            window.isSimplifiedMobile && window.isMobile && ((window.isAnimated = !1), n.removeClass("animated animateOnEvent"), $("[class*='ae-']").addClass("done")),
        ...
        d(window.stage),
            ...
            (window.changeSlide = function (a) {
                if (
                    ("increase" === a ? (a = window.stage + 1 >= window.stages ? window.stages : window.stage + 1) : "decrease" === a && (a = window.stage - 1 < 1 ? 1 : window.stage - 1),
                    (window.isMobile && window.isSimplifiedMobile) || window.isScroll)
                ) {
                    window.stage = a;
                    var b = $(".slide:eq(" + (window.stage - 1) + ")"),
                        c = $(b).offset().top;
                    $("html,body").stop().clearQueue().animate({ scrollTop: c }, window.effectSpeed);
        ...
        $("body").on("touchstart", function (a) {
            ...
            $("body").on("DOMMouseScroll mousewheel scroll touchend", function (a) {
                "touchend" == a.type && ((a.deltaY = a.changedTouches[0].clientY - p), (a.deltaFactor = 1));
                    ...
                    if (window.isScroll && !window.sidebarShown && !window.popupShown && !window.blockScroll)
                        if (window.smoothScroll && !window.isMobile) {
                            ...
                            var m = $(window),
                                o = m.scrollTop(),
                                q = o - g;
                            TweenLite.to(m, window.scrollSpeed, { scrollTo: { y: q, autoKill: !1 }, ease: Power4.easeOut, overwrite: "all" });
                        } else window.isWindows || b.scrollTop(i - g);
                    window.isScroll ||
                        (window.isMobile && window.isSimplifiedMobile) ||
                        (j > window.windowHeight &&
                            (("up" === h && 0 === b.scrollTop()) || ("down" === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k)) ? (window.allowSlide = 1) : (window.allowSlide = 0),
                            window.panelsToHide &&
                                ("down" === h && b.scrollTop() > 0 ? n.addClass("hidePanel-top") : "up" === h && n.removeClass("hidePanel-top"),
                            ...
                            window.sidebarShown ||
                                ...
                                window.blockScroll ||
                                (window.smoothScroll
                                    ? (g > 1500 && (g = 1500), g < -1e3 && (g = -1500), TweenLite.to(b, 0.5, { scrollTo: { y: i - g, autoKill: !1 }, ease: Power4.easeOut, overwrite: 5 }))
                                    : ((i = "up" === h ? i - c : i + c), b.scrollTop(i)))),
                        window.allowSlide &&
                            c &&
                            ("down" == h ? (window.collectScrolls = window.collectScrolls + c) : (window.collectScrolls = window.collectScrolls - c),
                            setTimeout(function () {
                                window.collectScrolls = 0;
                            }, 200)),
        ...
        if (
            ($(".mobile .slides:not(.scroll):not(.simplifiedMobile), .slides.desktopSwipe").swipe({
                swipeStatus: function (a, b, c, d) {
                    ...
                    window.sidebarShown && (e = $(".sidebar .content")),
                        ...
                        !window.horizontalMode && f > j && (window.scrollTop + j < f && (window.allowSwipeUp = 0), window.scrollTop > 0 && (window.allowSwipeDown = 0)),
                        window.sidebarShown ||
                            ...
                            (window.horizontalMode
                                ...
                                ? window.changeSlide("increase")
                                : c === h && d > i && window.allowSwipeDown && window.allowSlide && window.changeSlide("decrease"));
                },
                maxTimeThreshold: 0,
                fingers: "all",
            ...
            var r,
                s = 0,
                t = window.hideOnScrollSensitivity ? window.hideOnScrollSensitivity : 100,
                u = $(".panel.hideOnScroll");
            $(window).on("mousewheel", function (a) {
                var b = $(this).scrollTop(),
                    c = $(u),
                    d = Math.ceil(Math.abs(a.deltaY) * a.deltaFactor);
                b > r ? ((s += d), s >= t && (c.addClass("hide"), (s = t))) : ((s -= d), s <= t / 5 && ((s = 0), c.removeClass("hide"))),
                    (r = b),
            ...
            v.on("scroll", function (a) {
                if (!window.inAction) {
                    var b = $(this),
                        c = $(this).scrollTop(),
                        d = c > w ? "down" : "up";
                    "down" === d && b.scrollTop() > 0 ? (x && n.addClass("hidePanel-top"), y && n.addClass("hidePanel-bottom")) : "up" === d && n.removeClass("hidePanel-top hidePanel-bottom"), (w = c);
                }
            });
        }
        $(document).on("keydown", function (a) {
            ...
            window.disableKeyNavigation ||
                ...
                ((37 !== a.keyCode && 33 !== a.keyCode) || (a.preventDefault(), window.horizontalMode && window.changeSlide("decrease")),
                (38 !== a.keyCode && 33 !== a.keyCode) ||
                    (window.horizontalMode ? (a.preventDefault(), TweenLite.to(d, window.scrollSpeed, { scrollTo: { y: g, autoKill: !0 }, ease: Power4.easeOut, overwrite: 5 })) : (a.preventDefault(), window.changeSlide("decrease"))),
                (39 !== a.keyCode && 34 !== a.keyCode) || (window.horizontalMode && (a.preventDefault(), window.changeSlide("increase"))),
                (40 !== a.keyCode && 34 !== a.keyCode) ||
                    (window.horizontalMode ? (a.preventDefault(), TweenLite.to(d, window.scrollSpeed, { scrollTo: { y: g, autoKill: !0 }, ease: Power4.easeOut, overwrite: 5 })) : (a.preventDefault(), window.changeSlide("increase"))),
        ...
        if (
            ...
            $("a[href^='#'][target!='_blank']").click(function (a) {
                ...
                if (e.length > 0) {
                    ...
                    } else ($(this).hasClass("toLastSlide") && $("body").hasClass("lastSlide")) || ((window.stage = $(".slide").index(e) + 1), d(window.stage));
                    i();
                }
            }),
            ...
            $(document).on("mouseup touchstart", function (a) {
                var b = $(".sidebarShown .sidebar, .dropdownTrigger"),
                    c = a.target;
                !b.is(c) && 0 === b.has(c).length && window.hideSidebarOnBodyClick && $(c).hasClass("ignoreBodyClick") === !1 && i(), $(window).trigger("sidebarHidden");
            }),
                            ...
                            ? setTimeout(function () {
                                  $(f).addClass("animate active"),
                                      ...
                                      (window.clearPopupElementAnimation = setTimeout(function () {
                                          $(f).find("[class*='ae-']").addClass("done"), a.resolve("done");
                                      }, window.effectSpeed + window.cleanupDelay));
                              }, 100)
                            : a.resolve("done"),
                        a.promise()
                    ...
                    j.length > 0 &&
                        j.each(function () {
                            var a = $(this),
                                ...
                                c = b.indexOf("?") > -1 ? "&" : "?";
                            $(f).hasClass("autoplay") || (a.hasClass("autoplay") && a.closest(".slider li.selected").length) ? (a.attr("allow", "autoplay"), a.attr("src", b + c + "autoplay=1")) : a.attr("src") || a.attr("src", b);
                        }),
                        k.length > 0 &&
                            k.each(function () {
                                var a = $(this);
        ...
        var D = $(".slider"),
            E = function (a, b, c) {
                a.length > 0 &&
                    a.each(function () {
                        var a = $(this);
                        a.find(".now").text(b + 1), a.find(".total").text(c.children("li").length);
                    });
            },
            F = function (a, b) {
                if (
                    (a.find(">li iframe").each(function () {
                        var a = $(this).attr("src");
                        "string" == typeof a && a.indexOf("autoplay") != -1 && ((a = a.replace("?autoplay=1", "?").replace("&autoplay=1", "")), $(this).attr("src", a)),
                            (a = $(this).attr("data-src")),
                            "string" == typeof a && a.indexOf("autoplay") != -1 && ((a = a.replace("?autoplay=1", "?").replace("&autoplay=1", "")), $(this).attr("data-src", a));
                    }),
                    ...
                    if (c.length > 0) {
                        var d = c.attr("src") ? c.attr("src") : c.data("src"),
                            e = d.indexOf("?") > -1 ? "&" : "?";
                        d.indexOf("autoplay") == -1 && (c.attr("allow", "autoplay"), c.attr("src", d + e + "autoplay=1"));
                    }
        ...
        $(D).length > 0 &&
            $(D).each(function (a, b) {
                ...
                if (
                    ((c.hasClass("clickable") || c.hasClass("autoplay") || c.hasClass("swipeable")) &&
                    ...
                    c.swipe({
                        swipeStatus: function (a, b, d, e) {
                            "end" == b && e > h && ("right" == d && c.trigger("prev"), "left" == d && c.trigger("next"));
                        },
                        maxTimeThreshold: 0,
                        fingers: "all",
                    });
        ...
        $(document).on("click", "[data-slider-action]", function () {
            if ($(this).data("slider-id")) {
                ...
                window.sliderStatus && $html.removeClassByPrefix("slider_" + d).addClass("slider_" + d + "_" + b),
                    f.each(function () {
                        ...
                        "next" === e ? (a = d.nextOrFirst("li")) : "prev" === e ? (a = d.prevOrLast("li")) : (parseInt(e) || 0 === e) && ((b = parseInt(e)), (a = c.find(">li:eq(" + b + ")"))),
                            (b = a.index()),
            ...
            ($.fn.slidesDialog = function (a) {
                function b(a, b) {
                    var f = c(a);
                    if (
                        (a && a.settings && a.settings.template != f.template && ($(a).remove(), (a = !1)),
                        a || ((a = $(f.template)), a.attr("data-dialog-id", f.id), $(".dialogContainer").prepend(a), e(a.find("[data-dialog-action]")), (a = a[0])),
                        (a.settings = f),
                        d(a),
                ...
                var f = this;
                if (0 == f.length) {
                    if (!a.id) return alert("Error: you need to provide the 'id' property to create a dialog!"), !1;
                    f = $(document).find(".dialog[data-dialog-id=" + a.id + "]");
                }
                f.length
                    ? f.each(function (c, d) {
                          "string" != typeof a ? b(d, a) : ("open" == a && d.open(!0), "close" == a && d.close());
                      })
                    : b(!1, a);
            }),
